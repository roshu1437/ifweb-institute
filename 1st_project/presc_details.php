...
<html lang="en">
	<head>
        ...
        <link href="assets/assets/SPEC/css/lightbox.css" rel="stylesheet">
		<!-- Icons/Glyphs -->
	        ...
	        <nav class="navbar ownmenu">
	          ...
	          <div class="nav-right">
	            <ul class="navbar-right">
	              <!-- USER INFO -->
	              <li class="dropdown user-acc"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" ><img src="assets/images/user.jpg" width="50px" style="margin-top: -15px"></a>
					...
					<div class="col-xs-12 col-sm-6 col-md-6 gallery-holder">
					   <div class="product-item-holder size-big single-product-gallery small-gallery">
					        <div id="owl-single-product">
					    		<img src="assets/images/marina.jpg" width="100%" height="auto">
					        </div>
    ...
    <!-- /.single-product-gallery -->
					...
					<div class='col-sm-6 col-md-6 product-info-block'>
						<div class="product-info">
							<h1 class="name">Elisa Montero</h1>
							<div class="stock-container info-container m-t-10">
								<div class="row"><br>
									...
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value" style="margin-left:40px">ON-Treatment</span>
										</div>
									</div>
								</div>
		      				</div>
		                ...
		                <div class="stock-container info-container m-t-10">
		                  <div class="row">
		                    ...
		                    <div class="stock-box">
		                        ...
		                        <span class="label">Last Checkup Date :</span>
		                        <span class="label">Current Appointment :</span>
		                    ...
		                    <div class="stock-box">
		                        ...
		                        <span class="label">Total Checkups :</span>
		                    </div><br>
		                      <div class="stock-box">
					            <li class="col-md-6">
					              <label> Appointments
					                <select class="selectpicker" name="gender">
					                  <option class="hidden">Appointments Date/Time</option>
					                  <option>1st - 9-FEB-2019 / 6:30 PM / Saturday</option>
					                  <option>2nd - 12-FEB-2019 / 5:00 PM / Tuesday</option>
					                  <option>3rd - 20-FEB-2019 / 6:00 PM / Wednesday</option>
					                </select>
					              </label>
					            </li>
					            <li class="col-md-6" style="margin-left:250px;margin-top:-69px">
					              <label> Checkups
					                <select class="selectpicker" name="gender">
					                  <option class="hidden">Checkups Date/Time</option>
					                  <option>1st - 9-FEB-2019 / 6:30 PM / Saturday</option>
					                  <option>2nd - 12-FEB-2019 / 5:00 PM / Tuesday</option>
					                </select>
					              </label>
		                    ...
		                    <div class="col-sm-9">
		                      <div class="stock-box">
		                      <span class="value" style="margin-left:40px">151</span><br>
		                      <span class="value" style="margin-left:40px">Female</span><br>
		                      <span class="value" style="margin-left:40px">12-FEB-2019 / 5:00 PM / Tuesday</span><br>
		                      <span class="value" style="margin-left:40px">20-FEB-2019 / 6:00 PM / Wednesday</span><br>
		                      <span class="value" style="margin-left:40px">Dr. Mastani</span><br>
		                      <span class="value" style="margin-left:40px">Acanthamoeba Infection</span><br>
		                      <span class="value" style="margin-left:40px">Eye Care</span><br>
		                    </div><br>
		                      <div class="stock-box">
		                      	<span class="value" style="margin-left:40px">3</span><br>
		                      	<span class="value" style="margin-left:40px">2</span>
		                      </div>
		                  </div>
		                </div>
		              </div>
				  ...
				  <div class="description-container m-t-20">
					...
					<h4>Prescription on first checkup</h4>
					<p>
						Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
						Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
						Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
					</p><br>
					<h4>Prescription on second checkup</h4>
					<p>
						Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
						Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
						Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
	...
	<footer>
	    <div class="container">    
	      ...
	      <div class="col-md-3">
	        <h6>Health Blog</h6>
	       <img src="assets/images/health.jpg" width="100%" height="auto">
	      </div>
	      <!-- MY ACCOUNT -->
	      <div class="col-md-3">
	        <h6>MY ACCOUNT</h6>
    ...
    <script type="text/javascript" src="SPEC/js/lightbox.min.js"></script>
