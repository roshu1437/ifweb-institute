...
<!-- /.gallery-holder -->
              ...
              <div class="product-info">
                <div class="stock-container info-container m-t-10">
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <div class="stock-box">
                      <span class="value" style="margin-left:40px">12-FEB-2019 / 6:00 PM / Tuesday</span><br>
                      <span class="value" style="margin-left:40px">16-FEB-2019 / 5:30 PM / Friday</span><br>
		  ...
		  <div class="description-container m-t-20">
		  	...
		  	<a href="presc_details.php" target="_blank"><div class="btn" style="border:1px solid black;">Prescription & Other details</div></a>
		  </div>
    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        <div id="owl-single-product">
    <img src="assets/images/lily.jpg" width="100%" height="auto">
        </div>
        <!-- /.single-product-slider -->
    </div>
    <!-- /.single-product-gallery -->
...
<!-- /.gallery-holder -->
			<div class='col-sm-6 col-md-6 product-info-block'>
				<div class="product-info">
					<h1 class="name">Lilly Collins</h1>
					<div class="stock-container info-container m-t-10">
						<div class="row"><br><br>
							<div class="col-sm-2">
								<div class="stock-box">
                ...
                <div class="stock-container info-container m-t-10">
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      ...
                      <span class="value" style="margin-left:40px">12-FEB-2019 / 6:00 PM / Tuesday</span><br>
                      <span class="value" style="margin-left:40px">16-FEB-2019 / 5:30 PM / Friday</span><br>
                      <span class="value" style="margin-left:40px">Dr. Peeno</span><br>
                    </div>
                  </div>
                </div>
              </div>
		  ...
		  <div class="description-container m-t-20">
		  	...
		  	<div class="btn" style="border:1px solid black;">Prescription & Other details</div>
		  </div>
          <!-- /.description-container -->
				</div>
            <!-- /.product-info -->
    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        <div id="owl-single-product">
    <img src="assets/images/hattie.jpg" width="100%" height="auto">
        </div>
        <!-- /.single-product-slider -->
    </div>
    <!-- /.single-product-gallery -->
...
<!-- /.gallery-holder -->
					<div class='col-sm-6 col-md-6 product-info-block'>
						<div class="product-info">
							<h1 class="name">Hattie Watson</h1>
							<div class="stock-container info-container m-t-10">
								<div class="row"><br><br>
									<div class="col-sm-2">
										<div class="stock-box">
									...
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value" style="margin-left:40px">Healed</span>
										</div>
									</div>
								</div>
              </div>
                ...
                <div class="stock-container info-container m-t-10">
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      ...
                      <span class="value" style="margin-left:40px">12-FEB-2019 / 6:00 PM / Tuesday</span><br>
                      <span class="value" style="margin-left:40px">16-FEB-2019 / 5:30 PM / Friday</span><br>
                      <span class="value" style="margin-left:40px">Dr. Mukhtara</span><br>
                    </div>
                  </div>
                </div>
              </div>
